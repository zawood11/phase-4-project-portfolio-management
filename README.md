...
# Bonsi Money Management: UI background/functionality explained
...
## Author/Scope
This application was created by Zach Underwood to satisfy the Phase 4 Project requirements for Flatiron School.